...
enum class I2CError {
    ...
    master_RX_fifos_not_empty = 28, // Programming error. FIFOs not empty at start of transaction.
    master_TX_fifos_not_empty = 38, // Programming error. FIFOs not empty at start of transaction.
    address_nak = 9,
    data_nak = 10,
